...
(function() {
  var _, compile2SassAndJade, deleteFile, exec, fs, hassDir, hassParser, iconv, jadeDir, log, path, publicDir, readFileSync, sassDir, stepOne, writeFileSync;
  ...
  readFileSync = function(hass_file) {
    ...
    return fs.readFile(hass_file, function(err, data) {
      ...
      if (err) {
        ...
        str = str.split('\n');
        result = hassParser.parser(str, hass_file);
        return log(result[0]);
      }
    });
  };
